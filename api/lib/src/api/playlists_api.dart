...
class PlaylistsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<DbFulltrack>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<DbFulltrack>>> getMonthlyPlaylist({ 
    ...
    BuiltList<DbFulltrack>? _responseData;
    ...
    return Response<BuiltList<DbFulltrack>>(
      data: _responseData,
