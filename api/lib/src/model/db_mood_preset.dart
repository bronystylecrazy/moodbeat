...
/// * [valenceMin] 
@BuiltValue()
abstract class DbMoodPreset implements Built<DbMoodPreset, DbMoodPresetBuilder> {
  ...
  factory DbMoodPreset([void updates(DbMoodPresetBuilder b)]) = _$DbMoodPreset;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DbMoodPresetBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DbMoodPreset> get serializer => _$DbMoodPresetSerializer();
}

class _$DbMoodPresetSerializer implements PrimitiveSerializer<DbMoodPreset> {
  @override
  final Iterable<Type> types = const [DbMoodPreset, _$DbMoodPreset];

  @override
  final String wireName = r'DbMoodPreset';
  ...
  void _deserializeProperties(
    ...
    required DbMoodPresetBuilder result,
  ...
  @override
  DbMoodPreset deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DbMoodPresetBuilder();
