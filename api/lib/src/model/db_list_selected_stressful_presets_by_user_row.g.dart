...
part of 'db_list_selected_stressful_presets_by_user_row.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DbListSelectedStressfulPresetsByUserRow
    extends DbListSelectedStressfulPresetsByUserRow {
  @override
  ...
  factory _$DbListSelectedStressfulPresetsByUserRow(
          [void Function(DbListSelectedStressfulPresetsByUserRowBuilder)?
              updates]) =>
      (new DbListSelectedStressfulPresetsByUserRowBuilder()..update(updates))
          ._build();

  _$DbListSelectedStressfulPresetsByUserRow._(
      {this.description,
      this.emoji,
      this.energyMax,
      this.energyMin,
  ...
  @override
  DbListSelectedStressfulPresetsByUserRow rebuild(
          void Function(DbListSelectedStressfulPresetsByUserRowBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DbListSelectedStressfulPresetsByUserRowBuilder toBuilder() =>
      new DbListSelectedStressfulPresetsByUserRowBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DbListSelectedStressfulPresetsByUserRow &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'DbListSelectedStressfulPresetsByUserRow')
...
class DbListSelectedStressfulPresetsByUserRowBuilder
    implements
        Builder<DbListSelectedStressfulPresetsByUserRow,
            DbListSelectedStressfulPresetsByUserRowBuilder> {
  _$DbListSelectedStressfulPresetsByUserRow? _$v;
  ...
  DbListSelectedStressfulPresetsByUserRowBuilder() {
    DbListSelectedStressfulPresetsByUserRow._defaults(this);
  }

  DbListSelectedStressfulPresetsByUserRowBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DbListSelectedStressfulPresetsByUserRow other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DbListSelectedStressfulPresetsByUserRow;
  }

  @override
  void update(
      void Function(DbListSelectedStressfulPresetsByUserRowBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DbListSelectedStressfulPresetsByUserRow build() => _build();

  _$DbListSelectedStressfulPresetsByUserRow _build() {
    _$DbListSelectedStressfulPresetsByUserRow _$result;
    try {
      _$result = _$v ??
          new _$DbListSelectedStressfulPresetsByUserRow._(
